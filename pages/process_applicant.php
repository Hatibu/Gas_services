...
require ("ajax_function/send_new_appli_admin_fun.php");
...
<?php
	...
	<?php		
			...
			<tr>
				...
				<td name='first_name'>
					<input type='text' class='form-control' value='".$row["first_name"]."' id='first_name' readonly/>
				</td>
			</tr>
			...
			<tr>	
				...
				<td name='last_name'>
					<input type='text' class='form-control' value='".$row["middle_name"]."' id='lname'  readonly/>
				</td>
			</tr>
			...
			<tr>	
				...
				<td name='last_name'>
					<input type='text' class='form-control' value='".$row["last_name"]."' id='lname'  readonly/>
				</td>
			</tr>
			...
			<tr>
				...
				<td name='location'>
					<input type='text' class='form-control' value='".$row["location"]."' id='location' readonly />
				</td>
			</tr>
	...
	?>
			<tr>
				<th></th>
				<td>
					<input type="submit" value="Accept" class='btn btn-primary' name="submit" >
				</td>
			</tr>	
